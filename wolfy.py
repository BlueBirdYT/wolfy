...
async def on_reaction_add(reaction, user):
     if reaction.emoji == '🇬':           
            ...
            embed.add_field(name = 'n!getuser (mod or admin is required)',value ='use it like n!getuser (rolename)',inline = False)
            embed.add_field(name = 'n!userinfo (mod or admin is required)',value ='use it like n!userinfo @user',inline = False)
            embed.add_field(name = 'n!roleinfo (mod or admin is required)',value ='use it like n!roleinfo (rolename)',inline = False)
            ...
            embed.add_field(name = 'n!delchannel (admin is required', value ='use it like n!delchannel or n!delchannel #channelname',inline = False)
            embed.add_field(name = 'n!mute (mod or admin is required and must have log setup or automute will not work)', value ='use it like n!mute @user (mute time)',inline = False)
            embed.add_field(name = 'n!meme', value ='use it like n!meme',inline = False)
            embed.add_field(name = 'n!avatar', value ='use it like n!avatar or n!avatar @user',inline = False)
            embed.add_field(name = 'n!flipcoin', value ='use it like n!flipcoin',inline = False)
            embed.add_field(name = 'n!unmute (mod or admin is required)', value ='use it like n!unmute @user',inline = False)
...
def is_owner(ctx):
     return ctx.message.author.id in ["455322915471097857","382462227116195841"]
...
async def invite(ctx):
    r, g, b = tuple(int(x * 255) for x in colorsys.hsv_to_rgb(random.random(), 1, 1))
    embed = discord.Embed(color = discord.Color((r << 16) + (g << 8) + b))
    embed.set_image(url="https://cdn.discordapp.com/avatars/550959034052640772/008d4222022b7c2aee798ec85b4cc022.png?size=1024")
    embed.add_field(name = 'Link to invite me', value='https://discordapp.com/api/oauth2/authorize?client_id=550959034052640772&permissions=8&scope=bot')
    embed.add_field(name = 'bot info', value='Wolfy is a simple bot easy and fun to use we will do updates and keep improving the bot')
    await client.say(embed=embed)
    await client.delete_message(ctx.message)
...
async def help(ctx):
    if ctx.message.author.bot:
      ...
      embed.set_image(url = 'https://image.ibb.co/caM2BK/help.gif')
      embed.add_field(name = 'Having doubts? Join our server and clear your doubts. Server link:',value ='https://discord.gg/d4NsRNj',inline = False)
...
async def server(ctx):
    await client.say('link to join support server https://discord.gg/d4NsRNj')
...
async def on_message(message):
    ...
    if '<@550959034052640772>' in message.content:
